...
- The first value of the enum **should** be the name of the enum itself
  ...
  - The other values **should not** be prefixed by the name of the enum itself.
    ...
    code, which is unnecessarily verbose. C++ is an exception. C++ users
    **may** prefix all values with the name of the enum, as described in the 
...
[aip-216]: ./0216.md
[Protocol Buffer Style Guide]: https://developers.google.com/protocol-buffers/docs/style?hl=en#enums
